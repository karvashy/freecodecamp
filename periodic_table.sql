...
--
-- Name: elements unique_test; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_test UNIQUE (symbol);


--
-- Name: elements unique_test_1; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_test_1 UNIQUE (name);
